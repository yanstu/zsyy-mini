<template>
	<view class="centre">
		...
		<view class="central solid-top" style="margin: auto;">
			<plate @listenPlateChange="plateChange" :defaultPlate="plateNumber" />
			<!-- <plate @listenPlateChange="plateChange" :defaultPlate="plateNumber" v-if="isShow" /> -->
		</view>
			...
			this.$req.request({
				...
				success: res => {
					...
					if (res.data.code == 200) {
						...
						// 	this.carp.push(arr)
						// }
						this.carp = res.data.data.zhtcData.data.carCode;
