	...
	<view>
		<scroll-view scroll-y class="scrollPage">
			<view class="UCenter-bg">
				<view class="cu-avatar xl round box-headImg" @click="goMyInfo" v-if="uId" :style="{ backgroundImage: 'url(' + uId.avatarUrl + ')' }"></view>
				...
				<image src="https://kshht.gzmsdw.cn/imge_zsyy/html/wave.gif" mode="scaleToFill" class="gif-wave"></image>
			</view>
			...
			<view class="cu-list menu card-menu margin-top-xl margin-bottom-xl shadow-lg radius">
				<view class="cu-item arrow">
					...
					<view class="content" style="display: flex;" @click="goMyOrder">
						<view class="aliView"><image src="https://kshht.gzmsdw.cn/imge_zsyy/html/服务.png" class="png" mode="aspectFit"></image></view>
			...
			<van-dialog show-cancel-button @close="closeDialog" use-slot title="请选择当前所在小区及单元" :show="dialogShow" @confirm="bind">
